  ...
  Widget build(BuildContext context) {
    ...
    if (dropdownMenuItem.enabled) {
      ...
      child = InkWell(
        ...
        child: Container(
          color: _isSelectedItem ? widget.route.selectedItemHighlightColor : null,
          child: child,
        ),
      );
    }
...
class DropdownButton2State<T> extends State<DropdownButton2<T>> with WidgetsBindingObserver {
  ...
  TextStyle? get _textStyle => widget.style ?? Theme.of(context).textTheme.bodyMedium;
  ...
  double get _denseButtonHeight {
    ...
    final double fontSize = _textStyle!.fontSize ?? Theme.of(context).textTheme.bodyMedium!.fontSize!;
    ...
    return Semantics(
      ...
      child: Actions(
        ...
        child: InkWell(
          ...
          focusColor: widget.buttonDecoration?.color ?? widget.focusColor ?? Theme.of(context).focusColor,
