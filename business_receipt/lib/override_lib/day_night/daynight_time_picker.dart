...
dynamic showPicker({
  ...
  EdgeInsets contentPadding = const EdgeInsets.symmetric(horizontal: 12.0, vertical: 12.0),
  ...
  TimeModelBinding timeModelBinding(child) => TimeModelBinding(
        ...
        width: width ?? dialogSizeGlobal(level: Level.mini),
        height: height,
            ...
            builder: (context) {
              return Theme(
                ...
                child: DayNightTimePickerAndroid(
                  ...
                  duskSpanInMinutes: duskSpanInMinutes,
                  width: width ?? dialogSizeGlobal(level: Level.mini),
                  height: height ?? (dialogSizeGlobal(level: Level.mini) + 100),
                ),
              );
            },
          );
  ...
  return PageRouteBuilder(
    pageBuilder: (context, _, __) {
      return Theme(
        ...
        child: DayNightTimePickerAndroid(
          width: width ?? dialogSizeGlobal(level: Level.mini),
          height: height ?? dialogSizeGlobal(level: Level.mini),
          sunrise: sunrise,
          sunset: sunset,
          duskSpanInMinutes: duskSpanInMinutes,
        ),
