...
import 'package:business_receipt/override_lib/pie_chart/chart_values_options.dart';
import 'package:business_receipt/override_lib/pie_chart/legend_options.dart';
import 'package:business_receipt/override_lib/pie_chart/pie_chart.dart';
...
class HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    final chart = PieChart(
      ...
      centerWidget: _showCenterWidget ? Container(color: Colors.red, child: const Text("Center")) : null,
